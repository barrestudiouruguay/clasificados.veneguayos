...
const RUBROS = {
  ...
  cadeteria:      { label:'Cadetera / delivery',                 svg:`<svg viewBox="0 0 32 32" ${IC}><circle cx="10" cy="24" r="2"/><circle cx="24" cy="24" r="2"/><path d="M4 10h14v10H4ZM18 14h6l4 4v6h-4"/></svg>` },
  ...
  return `<footer class="site-footer">
    <div class="footer-inner">
      <div class="footer-top">
        ...
        <div class="footer-col">
          <h4>Contacto</h4>
          <a href="https://instagram.com/clasificados.veneguayos" target="_blank">\u1F4F7 @clasificados.veneguayos</a>
      ...
      <div class="footer-bottom" style="margin-top:20px;">
        ...
        <span style="font-size:1.1rem;">\u1F1FB\u1F1EA \u1F1FA\u1F1FE</span>
      </div>
